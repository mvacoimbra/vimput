...
export function VimputEditor({
  ...
  const [vimState, setVimState] = useState<VimState>(() => createInitialState(initialText))
  ...
  return (
    ...
    >
      <CardHeader className="flex flex-row items-center justify-between py-2 px-4 border-b border-zinc-700">
        <CardTitle className={cn('text-lg font-mono', isDark ? 'text-zinc-100' : 'text-zinc-900')}>
          Vimput Editor
        </CardTitle>
      ...
      <CardContent className="p-0">
        ...
        >
          <div className="flex items-center gap-3">
            <Badge className={cn(getModeColor(vimState.mode), 'text-white uppercase text-xs')}>
              {vimState.mode}
            </Badge>
